...
public:
    ...
    void setUndersteerYawWnd(sWins_t*);
    sWins_t* getUndersteerYawWnd() { return understeerYawWnd; }
    
    void setUndersteerLateralFactorWnd(HWND);
    HWND getUndersteerLateralFactorWnd() { return understeerLateralFactorWnd; }
    ...
    bool setUndersteerYawFactor(float, HWND);
    float getUndersteerYawFactor() { return understeerYawFactor; }

    bool setUndersteerLateralFactor(int, HWND);
    float getUndersteerLateralFactor() { return understeerLateralFactor; }

    void setUndersteerLateralFactorType(int);
    int getUndersteerLateralFactorType() { return underSteerLateralFactorType; }
    ...
    float getUndersteerYawFactorSetting();
    
    float getUndersteerLateralFactorSetting();
...
private:
    HWND devWnd, ffbWnd, understeerLateralFactorWnd;
    sWins_t* minWnd, * maxWnd, * bumpsWnd, * dampingWnd, * sopWnd, * sopOffsetWnd, * understeerWnd, * understeerOffsetWnd, * understeerYawWnd;
    HWND use360Wnd, carSpecificWnd, reduceWhenParkedWnd;
    HWND runOnStartupWnd, startMinimisedWnd, debugWnd;
    int ffbType, ffdeviceIdx, minForce, maxForce, underSteerLateralFactorType;
    float scaleFactor, bumpsFactor, dampingFactor, sopFactor, sopOffset, understeerFactor, understeerOffset, understeerYawFactor, understeerLateralFactor;
    ...
    wchar_t* underSteerLateralFactorTypeString(int);
    PWSTR getIniPath();
